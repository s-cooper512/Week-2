...
The variable profileID is accessible on which lines? (That is: on which lines can it be console.logged without throwing an error?)
A, B, I, J, K
K
-(All lines)-
All lines except A
